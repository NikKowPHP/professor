      ...
      <div className="flex flex-col  gap-[20px]">
        <div className="border border-blue-500 flex flex-col items-center gap-[40px]">
          ...
          <h3 className="flex flex-col items-center gap-[10px]">
            ...
            <span className="font-bold ">Health Democratise Enabler</span>
          </h3>
        ...
        {/* cta */}
        <div>
          <Link href="/about" className="flex items-center gap-[10px]">My Investments <ArrowUpRight className="w-6 h-6" /></Link>
        </div>
      </div>
